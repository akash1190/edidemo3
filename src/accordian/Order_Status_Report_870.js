...
import { osrAPI } from "../ApiServices";
import { osr1API } from "../ApiServices";
const Order_Status_Report_870 = () => {
  ...
  return (
   <div class="container">
     <div className="genral_search">
          <h2 className="mt2">Order Status Report - 870</h2>
                      ...
                      return (
                        <tr class="odd">
                          <td class="dtr-control sorting_1" tabindex="0">
                              ...
                              {items1["LineID"]}</td>
                              <td>{items1["BuyerPartNumber"]}</td>
                              <td>{items1["ItemStatus"]}</td>

                              <td>{items1["ProductDescription"]}</td>
                              <td>{items1["QuantityShipped"]}</td>
                              <td>{items1["Quantityordered"]}</td>
                              <td>{items1["TotalPrice"]}</td>
                              <td>{items1["UnitPrice"]}</td>
                              <td>{items1["VendorPartNumber"]}</td>
                            </tr>
                      );
                    })}
                  </tbody>
...
export default Order_Status_Report_870;
