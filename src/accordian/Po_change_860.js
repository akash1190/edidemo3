...
import { pocAPI } from "../ApiServices";
import { poc1API } from "../ApiServices";
const Po_change_860 = () => {
  ...
  return (
   <div class="container">
     <div className="genral_search">
          <h2 className="mt2">Purchase Order Change Request - 860</h2>
