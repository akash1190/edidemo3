     ...
     const [data, setData] = useState({
      ...
      const Charttest = ()=>{
        ...
        const hash = Base64.encode(tok);
          ...
          const dataSet2 = []
          const dataSet3 = []
      axios.get('https://testboomi.india.rsystems.com:9090/ws/rest/dashboard/v1/856Chart/',{headers : { 'Authorization' : Basic }})
      .then((response)=>{
        ...
        // const chartData= JSON.parse(response.data)
             ...
             for (const data of response.data[0]) {
                 ...
                 dataSet1.push(data["2019 Data Count"])
                 dataSet2.push(data["2020 Data Count"])
                 dataSet3.push(data["2021 Data Count"])
