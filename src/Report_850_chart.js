     ...
     const [data, setData] = useState({
      ...
      const Charttest = ()=>{
        ...
        const hash = Base64.encode(tok);
          ...
          const dataSet2 = []
          const dataSet3 = []
      axios.get('https://testboomi.india.rsystems.com:9090/ws/rest/dashboard/v1/850Chart/',{headers : { 'Authorization' : Basic }})
      .then((response)=>{
...
<Line options={options1} data={data} />
 ...
 export default Report_850_chart;